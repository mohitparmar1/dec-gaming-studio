...
const HomeComponent = () => {
  return (
    <>
      ...
      <div className="w-full h-full bg-[#CAF4FF]" id="career">
        <div
          className="w-full h-full flex flex-col items-center justify-center my-10 mx-24"
        >
          ...
          <div className="flex flex-col flex-1">
            <div className="flex flex-col gap-3">
              <h2 className="font-bold text-xl text-blue-500"><a href="https://5c5bcaaebf931.site123.me/career/unity-game-developer"  target="_blank" className="underline">AR Developer:</a> 2 to 5 years Exp. - Remote Work</h2>
              ...
              <ul className="list-decimal mx-10">
                ...
                <li>
                  ...
                  development stage so getting exposure to the entire lifecycle
                  of games
                </li>
                <li>
                  Integrating analytics and ads and also being involved with the
                  analytics team to understand what can be changed in the games
                  to increase user experience and retention
                </li>
              </ul>
              <p className="">
                Send your CV to '<span className="font-semibold cursor-pointer">jobs@decgamingstudio.com</span>'
              </p>
            </div>
            <div className="flex">
              <img src={Img3} alt="logo" className="w-3/4 h-3/4 object-cover" />
            </div>
          </div>
        </div>
      </div>
